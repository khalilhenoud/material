/**
 * @file indexed_material_asset.h
 * @author khalilhenoud@gmail.com
 * @brief a combo of bulk material ref and an index into it
 * @version 0.1
 * @date 2026-04-21
 *
 ...
 *
 */
#ifndef INDEXED_MATERIAL_ASSET_H
#define INDEXED_MATERIAL_ASSET_H
...
////////////////////////////////////////////////////////////////////////////////
//| indexed_material_asset_t, '*' = indexed_material_asset
//|=============================================================================
//| OPERATION                   | SUPPORTED
//|=============================================================================
//|    *_def                    | YES
...
typedef
struct indexed_material_asset_t {
  asset_ref_t bulk_material_ref;
  uint32_t index;
} indexed_material_asset_t;
